...
TEXT_PATH="https://raw.githubusercontent.com/mrdani13/sub-checker/refs/heads/main/normal.txt"
FIN_PATH="final.txt"
FIN_CONF=[]
...
if TEXT_PATH.startswith("http://") or TEXT_PATH.startswith("https://"):
        response = requests.get(TEXT_PATH, timeout=15)
